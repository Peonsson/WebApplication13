namespace WebApplication13.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<WebApplication13.Models.WebApplication13Context>
    {
        ...
        protected override void Seed(WebApplication13.Models.WebApplication13Context context)
        {
            ...
            Message msg2 = new Message { Email = "peonsson@gmail.com", Id = 2, Image = "hello world2", Sender = isak, Receiver = johan, Text = "hello world2", Timestamp = DateTime.Now };
            Message msg3 = new Message { Email = "peonsson@gmail.com", Id = 3, Image = "hello world2", Sender = axel, Receiver = johan, Text = "hello world2", Timestamp = DateTime.Now };
            ...
            Message msg5 = new Message { Email = "peonsson@gmail.com", Id = 5, Image = "hello world2", Sender = robin, Receiver = johan, Text = "hello world2", Timestamp = DateTime.Now };
